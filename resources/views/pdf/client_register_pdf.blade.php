...
<body>
    ...
    <div class="WordSection1">
        ...
        <div class="form-section">
            <p>Name Of Client :
                <span style="display: inline-block; width: 60%; padding-bottom: 2px; text-align: left;">
                    _________________________
                </span>
            </p>
            <p>Client Code :
                <span style="display: inline-block; width: 30%; padding-bottom: 2px; text-align: center;">
            ...
            <thead style="background-color: #757879 !important;">
                ...
                <tr>
                    ...
                    <th rowspan="2" class="d-flex">
                        <div class="square-box" style="width: 15px; height: 15px; border: 1px solid #000;"></div> New
                    </th>
                    <th rowspan="2" class="d-flex">
                        <div class="square-box" style="width: 15px; height: 15px; border: 1px solid #000;"></div> Update
                    </th>
                </tr>
                <tr>
                    <th colspan="5">
                    ...
                    <th rowspan="2" class="d-flex">
                        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: nowrap;">
                            <label style="display: flex; align-items: center; gap: 5px; white-space: nowrap;">
                                <div class="square-box" style="width: 15px; height: 15px; border: 1px solid #000;"></div> Normal
                            </label>
                        </div>
                    </th>
                    <th rowspan="2" class="d-flex">
                        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: nowrap;">
                            <label style="display: flex; align-items: center; gap: 5px; white-space: nowrap;">
                                <div class="square-box" style="width: 15px; height: 15px; border: 1px solid #000;"></div> Simplified (for low risk customer)
                            </label>
                        </div>
                    </th>
                    <th rowspan="2" class="d-flex">
                        <div style="display: flex; align-items: center; gap: 20px; flex-wrap: nowrap;">
                            <label style="display: flex; align-items: center; gap: 5px; white-space: nowrap;">
                                <div class="square-box" style="width: 15px; height: 15px; border: 1px solid #000;"></div> Small
                            </label>
                        </div>
                    </th>
                </tr>
