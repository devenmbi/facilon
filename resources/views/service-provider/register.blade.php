                      ...
                      <h2>Investor Registration</h2>
                            ...
                            <div class="login-register3-form-middle">
                                @if ($provider_id == 1 || $provider_id == 2 || $provider_id == 3)
                                    <form action="{{ route('service_provider_registration_step1_submit') }}"
                                        ...
                                        <div class="single-field intro-name">
                                            <label for="username"><span
                                                    class="referred-name">{{ $get_provider_name->title }} Details </span>
                                            </label>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Full Name:
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Corporate
                                                            Office Address: <span class="star-color">*</span>
                                                        </label>

                                                        <input type="text" name="corporate_office_address"
                                                            value="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> TEL: <span
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Fax: <span
                                                                class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Website:
                                                            <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> CIN NO: <span
                                                                class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> NSE SEBI Reg
                                                            No: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> NSE F&O SEBI
                                                            Reg No: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> BSE SEBI Reg
                                                            No: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> BSE F&O
                                                            SEBI Reg No: <span class="star-color">*</span>
                                                        </label>

                                                        <input type="text" name="bse_f_and_o_sebi_reg_no"
                                                            value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field mb-0">
                                                        <a href="" class="button-1"
                                                            style="padding: 12px 20px;font-size: 18px;display: inline-block;width: 100%;text-align:center;"
                                    ...
                                    <form action="{{ route('service_provider_registration_step1_submit') }}"
                                        ...
                                        <div class="name-sec" id="section_self_div">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Name of the
                                                            Bank: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Name of
                                                            Contact Person: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Address
                                                            Line 1: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Address
                                                            Line 2: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Country:
                                                            <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> State:
                                                            <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> City: <span
                                                                class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Pin Code /
                                                            Zip Code: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Email:
                                                            <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Phone No
                                                            (Bank): <span class="star-color">*</span>
                                                        </label>
                                ...
                                @else
                                    <form action="{{ route('service_provider_registration_step1_submit') }}"
                                        ...
                                        <div class="single-field self-sec">
                                            <label for="username">Are you registering for Natural Person or Legal Entity:
                                                <span class="star-color">*</span></label>
                                            <div class="radio-box">
                                                <label class="radio expander">
                                                    <input name="natural_person" type="radio"
                                                        onclick="change_register()" value="Natural Person"
                                                        checked="checked">
                                                    <span>Natural Person</span>
                                                </label>
                                                <label class="radio">
                                                    <input name="natural_person" type="radio"
                                                        onclick="change_register()" value="Legal Entity">
                                        ...
                                        <div class="row">
                                            <div class="name-sec" id="section_natural_person_div">
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Name: <span
                                                                class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Mobile No:
                                                            <span class="star-color">*</span>
                                                        </label>
                                            ...
                                            <div class="name-sec" id="section_legal_div" style="display:none;">
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Name of
                                                            Introducer: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i> Introducer
                                                            Phone: <span class="star-color">*</span>
                                                        </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="single-field">
                                                        <label for="username"><i class="fa-solid fa-user"></i>Designation:
                                                            <span class="star-color">*</span>
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> Address Line 1:
                                                        <span class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> Country: <span
                                                            class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> State: <span
                                                            class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> Pin Code / Zip
                                                        Code: <span class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> Name of
                                                        Overseas Regulator: <span class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> SEBI Reg No:
                                                        <span class="star-color">*</span>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-field">
                                                    <label for="username"><i class="fa-solid fa-user"></i> SEBI
                                                        Registration Valid Till Date: <span class="star-color">*</span>
                                                    </label>
